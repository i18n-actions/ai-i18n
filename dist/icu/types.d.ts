 ...
 */
export declare const PLURAL_CATEGORIES: PluralCategory[];
/**
...
export interface PluralVariant {
    category: PluralCategory | string;
    text: string;
}
/**
 ...
 */
export type ICUElement = ICUTextElement | ICUArgumentElement | ICUPluralElement | ICUSelectElement | ICUSelectOrdinalElement;
/**
